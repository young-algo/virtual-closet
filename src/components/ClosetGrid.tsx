...
import { Search, Plus, Check, X, SlidersHorizontal, Edit2, AlertCircle, Shirt } from 'lucide-react';
    ...
    <section className="closet-section" style={{ display: 'flex', flexDirection: 'column', gap: '24px', flexGrow: 1 }}>
      ...
      <div className="filter-panel" style={{
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
            ...
            <h2 style={{ fontSize: '1.25rem', fontFamily: 'var(--font-heading)' }}>Filter Closet</h2>
          </div>
          {isAnyFilterActive && (
            <button
      ...
      {items.length === 0 ? (
        <div style={{
          ...
          <Shirt size={48} strokeWidth={1.5} style={{ color: 'var(--accent-primary)', opacity: 0.7 }} />
          <h3 style={{ fontSize: '1.25rem', fontWeight: 500 }}>Your wardrobe is waiting</h3>
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--text-secondary)', marginBottom: '8px' }}>No items found matching your filters.</p>
          <button
            onClick={clearAllFilters}
            className="tap-target"
            style={{
              ...
              <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                {!isEditing ? (
                  <>
                    <div>
                      ...
                      <h2 style={{ fontSize: '1.4rem', marginTop: '4px', fontFamily: 'var(--font-heading)' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', borderTop: '1px solid var(--border-color)', paddingTop: '16px' }}>
                      <div>
                        ...
                        <strong style={{ fontSize: '0.9rem', fontWeight: 500 }}>{activeDetailItem.category}</strong>
                      </div>
                      <div>
                        <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', display: 'block' }}>Color</span>
                        <strong style={{ fontSize: '0.9rem', fontWeight: 500 }}>{activeDetailItem.color}</strong>
                      </div>
                    </div>
                  </>
                ) : (
                ...
                {showDeleteConfirm ? (
                  <div style={{
                    ...
                    <p style={{ fontSize: '0.85rem', color: '#ff6b6b', fontWeight: 500, textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
                      <AlertCircle size={14} />
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: 'auto', paddingTop: '12px' }}>
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 'var(--radius-sm)',
                        border: 'none',
                        backgroundColor: packedItemIds.includes(activeDetailItem.id) ? 'var(--border-color)' : 'var(--accent-primary)',
